<%----------------------------------------------------------------------------------------
 - 파일이름	: system/syscod/GrCodeMod.jsp
...
<!-- 그룹 코드 -->
					<section class="col col-5">
						...
						<label class="input">							
							<input type="text" name="mod_grcode" id="mod_grcode" value="<%=VO.getGrcode()%>" disabled="disabled">
							<i></i>
						</label>
					</section>
<!-- 코드명 한글 -->
					<section class="col col-5">
						...
						<label class="input">
							<input type="text" name="mod_grcodenm_k" id="mod_grcodenm_k" value="<%=VO.getGrcodenm_k()%>">
						</label>												
					</section>			
				</div>
			</fieldset>
...
<!-- 코드명 영어 -->
					<section class="col col-5">
						...
						<label class="input">
							<input type="text" name="mod_grcodenm_e" id="mod_grcodenm_e" value="<%=VO.getGrcodenm_e()%>">
						</label>												
					</section>
<!-- 코드명 일어 -->
					<section class="col col-5">
						...
						<label class="input">
							<input type="text" name="mod_grcodenm_j" id="mod_grcodenm_j" value="<%=VO.getGrcodenm_j()%>">
						</label>												
					</section>				
				</div>
			</fieldset>					
...
$(document).ready(function(){
	...
	$("#grCdModForm").validate({
		...
		submitHandler: function (form) {
			var param = {
					actionID:"<%=SysCodConstKey.ACTION_SYSCOD_UPDATE_OK%>",
             ...
             $.ajax({
                type: "POST",
                url: "<%=ConstUrl.SYSTEM_SYSCOD_GRCODE_POP_MOD_URL%>?v=" + (new Date().getTime()),
                data: param,
                dataType: "json",
                async: true,
                cache: false,
